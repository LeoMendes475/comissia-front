...
export function AffiliatesEdit() {
    ...
    useEffect(() => {
        const fetchAffiliateData = async () => {
            try {
                const response = await api.get(`/affiliates/findById/${id}`);
                const affiliateData: AffiliateData = response.data;
    ...
    const handleSubmit = async () => {
        ...
        try {
            const response = await api.patch(`/affiliates/update/${id}`, userData);
            navigate('/affiliatesList');
            console.log("Afiliado atualizado:", response.data);
        } catch (error) {
            console.error("Erro ao atualizar o afiliado:", error);
        }
    };
